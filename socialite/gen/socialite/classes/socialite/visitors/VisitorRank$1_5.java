...
;
    public  VisitorRank$1_5(int _$epochId, int _$ruleId, Double _$$const3, Double _$$const4, Integer _$$const5, Node_int_indexby0_range0to1274502_groupby0_id3 _$$_node0, Rank$1_int_double_indexby0_range0to1274502_groupby0_id5 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $const3=_$$const3;
        $const4=_$$const4;
        $const5=_$$const5;
        $_node0 = _$$_node0;
    ...
    public String toString() {
        String str="Rank$1(n,$Builtin.sum(r)) :- Node(n),r=((0.15*1.0)/1274502). epoch:"+$epochId;
        return str;
    }
