...
public final class VisitorRank$0_4 extends VisitorImpl implements Runnable {
...
;
    public  VisitorRank$0_4(int _$epochId, int _$ruleId, Double _$$const2, Integer _$$const3, Node_int_indexby0_range0to1274502_groupby0_id3 _$$_node0, Rank$0_int_double_indexby0_range0to1274502_groupby0_id4 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $const2=_$$const2;
        $const3=_$$const3;
        $_node0 = _$$_node0;
        $headTable=$$headTable;
