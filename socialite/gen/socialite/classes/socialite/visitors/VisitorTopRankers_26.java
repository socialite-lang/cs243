...
public final class VisitorTopRankers_26 extends VisitorImpl implements Runnable {
...
;
    public  VisitorTopRankers_26(int _$epochId, int _$ruleId, Double _$$const2, Double _$$const3, Rank$1_int_double_indexby0_range0to1274502_groupby0_id5 _$$_rank$10, TopRankers_int_double_indexby0_groupby0_id7[] $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $const2=_$$const2;
        $const3=_$$const3;
        $_rank$10 = _$$_rank$10;
        $headTable=$$headTable;
    ...
    public String toString() {
        String str="TopRankers(n,rank) :- Rank$1(n,rank),(rank>(9.49539466146E-5*0.4)). epoch:"+$epochId;
        return str;
    }
