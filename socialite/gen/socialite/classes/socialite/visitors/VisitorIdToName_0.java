...
public final class VisitorIdToName_0 extends VisitorImpl implements Runnable {
    private IdToName_int_String_indexby0_range0to1274502_indexby1_groupby0_id0 $headTable;
...
;
    public  VisitorIdToName_0(int _$epochId, int _$ruleId, String _$$const0, String _$$const1, IdToName_int_String_indexby0_range0to1274502_indexby1_groupby0_id0 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $const0=_$$const0;
        $const1=_$$const1;
        $headTable=$$headTable;
        $epochId=_$epochId;
              	...
              	try {
              	    ...
              	    try {
              	        ...
              	        try {
              	            ...
              	            IdToName_int_String_indexby0_range0to1274502_indexby1_groupby0_id0 _$$headTable=$headTable;
    ...
    public String toString() {
        String str="IdToName(id,n) :- l=$Builtin.read(\"data/authorId.txt\"),(n, s2)=$Builtin.split(l, \"\t\"),id=$Builtin.toInt(s2). epoch:"+$epochId;
        return str;
    }
