...
public final class VisitorPath2_4 extends VisitorImpl implements Runnable {
    private Path2_int_int_int_indexby0_range0to1274502_groupby0_id3 $_path20;
...
;
    public  VisitorPath2_4(int _$epochId, int _$ruleId, Integer _$$const3, Path2_int_int_int_indexby0_range0to1274502_groupby0_id3 _$$_path20, Edge_int_int_int_nest1_indexby0_range0to1274502_groupby0_id1 _$$_edge1, Path2_int_int_int_indexby0_range0to1274502_groupby0_id3 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $const3=_$$const3;
        $_path20 = _$$_path20;
        $_edge1 = _$$_edge1;
        $headTable=$$headTable;
    ...
    public void run() {
        do {
          $currentPredicate=0;
          $_path20.iterate_range_0($sliceMap.getRange(3,0,$firstTableIdx)[0],$sliceMap.getRange(3,0,$firstTableIdx)[1],this);
        } while (false);;
    }
    ...
    public Delta_Path2_int_int_int_groupby0_id3 getDeltaTable() {
        if (delta$Path2==null) {
            delta$Path2=(Delta_Path2_int_int_int_groupby0_id3)TmpTablePool.get(getWorkerId(),Delta_Path2_int_int_int_groupby0_id3.class,0);
    ...
    public String toString() {
        String str="Path2(n,$Builtin.min(d),prev) :- Path2(s,d1,prev1),Edge(s,n,_$0),d=(d1+1),prev=s. epoch:"+$epochId;
        return str;
    }
