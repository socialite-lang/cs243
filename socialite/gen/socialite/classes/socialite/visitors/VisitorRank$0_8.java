...
public final class VisitorRank$0_8 extends VisitorImpl implements Runnable {
...
;
    public  VisitorRank$0_8(int _$epochId, int _$ruleId, Double _$$const8, Rank$1_int_double_indexby0_range0to1274502_groupby0_id5 _$$_rank$10, EdgeCnt_int_int_indexby0_range0to1274502_groupby0_id2 _$$_edgeCnt1, Edge_int_int_nest1_indexby0_range0to1274502_groupby0_id1 _$$_edge3, Rank$0_int_double_indexby0_range0to1274502_groupby0_id4 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $const8=_$$const8;
        $_rank$10 = _$$_rank$10;
    ...
    public boolean visit(int _0) {
        do {
          switch ($currentPredicate) {
              ...
              int $_slice_14=$sliceMap.getRangeIndex(4,0,n);
              try {
                  $lockMap.lock(4, $_slice_14);
    ...
    public String toString() {
        String str="Rank$0(n,$Builtin.sum(r)) :- Rank$1(s,r1),EdgeCnt(s,cnt),r=((0.85*r1)/cnt),Edge(s,n). epoch:"+$epochId;
        return str;
    }
