...
;
    ...
    public String toString() {
        String str="Rank$0(n,$Builtin.sum(r)) :- Rank$1(s,r1),EdgeCnt(s,cnt),r=((0.9*r1)/cnt),Edge(s,n). epoch:"+$epochId;
        return str;
    }
