...
import socialite.tables.Delta_Path_int_int_int_groupby0_id3;
...
public final class VisitorPath_5_delta0 extends VisitorImpl implements Runnable {
    private Delta_Path_int_int_int_groupby0_id3 $_delta_Path0;
...
;
    public  VisitorPath_5_delta0(int _$epochId, int _$ruleId, Integer _$$const3, Delta_Path_int_int_int_groupby0_id3 _$$_delta_Path0, Edge_int_int_int_nest1_indexby0_range0to1274502_groupby0_id1 _$$_edge1, Path_int_int_int_indexby0_range0to1274502_groupby0_id3 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $const3=_$$const3;
        $_delta_Path0 = _$$_delta_Path0;
        $_edge1 = _$$_edge1;
        $headTable=$$headTable;
        $epochId=_$epochId;
        $ruleId=_$ruleId;
    ...
    public void run() {
        do {
          $currentPredicate=0;
          if ($_delta_Path0.virtualSliceNum()>1) {
              $_delta_Path0.iterate_range((($_delta_Path0.size()+$_delta_Path0.virtualSliceNum()-1)/$_delta_Path0.virtualSliceNum())*$firstTableIdx,(($_delta_Path0.size()+$_delta_Path0.virtualSliceNum()-1)/$_delta_Path0.virtualSliceNum())*($firstTableIdx+1)-1,this);
          } else {
              $_delta_Path0.iterate(this);
          };
        } while (false);;
    }
    ...
    public Delta_Path_int_int_int_groupby0_id3 getDeltaTable() {
        if (delta$Path==null) {
            delta$Path=(Delta_Path_int_int_int_groupby0_id3)TmpTablePool._get(getWorkerId(),Delta_Path_int_int_int_groupby0_id3.class,0);
    ...
    public String toString() {
        String str="Path(n,$Builtin.min(d),prev) :- Delta_Path(s,d1,prev1),Edge(s,n,_$0),d=(d1+1),prev=s. epoch:"+$epochId;
        return str;
    }
