...
import socialite.tables.PaperCnt_int_int_indexby0_range0to1274502_groupby0_id2;


public final class VisitorPaperCnt_2 extends VisitorImpl implements Runnable {
    private PaperCnt_int_int_indexby0_range0to1274502_groupby0_id2 $headTable;
...
;
    public  VisitorPaperCnt_2(int _$epochId, int _$ruleId, String _$$const0, String _$$const1, PaperCnt_int_int_indexby0_range0to1274502_groupby0_id2 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $const0=_$$const0;
        $const1=_$$const1;
        $headTable=$$headTable;
        $epochId=_$epochId;
    ...
    public void run() {
        do {
          ;
          try {
              Iterator $iter8 = Builtin.read($const0) ;
              while ($iter8.hasNext()) {
              	java.lang.String $v9 = (java.lang.String)$iter8.next();
              	l=(java.lang.String)$v9;
              	;
              	try {
              	    {Object[] $array10=(Object[])Builtin.split(l, $const1) ;
              	    s1=(java.lang.String)$array10[0];
              	    s2=(java.lang.String)$array10[1];};
              	    ;
              	    try {
              	        {n=Builtin.toInt(s1) ;};
              	        ;
              	        try {
              	            {cnt=Builtin.toInt(s2) ;};
              	            int $_slice_11=$sliceMap.getRangeIndex(2,0,n);
              	            try {
              	                $lockMap.lock(2, $_slice_11);
              	                boolean $isUpdated=false;
              	                PaperCnt_int_int_indexby0_range0to1274502_groupby0_id2 _$$headTable=$headTable;
              	                $isUpdated=_$$headTable.insert(n, cnt);
              	                if ($isUpdated) {
              	                    {;};
              	                };
              	                if ($isUpdated) {
    ...
    public String toString() {
        String str="PaperCnt(n,cnt) :- l=$Builtin.read(\"data/paperCount.txt\"),(s1, s2)=$Builtin.split(l, \"\t\"),n=$Builtin.toInt(s1),cnt=$Builtin.toInt(s2). epoch:"+$epochId;
        return str;
    }
