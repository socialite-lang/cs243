...
public final class VisitorRank$1_8 extends VisitorImpl implements Runnable {
...
;
    public  VisitorRank$1_8(int _$epochId, int _$ruleId, Double _$$const8, Rank$0_int_double_indexby0_range0to1274502_groupby0_id4 _$$_rank$00, EdgeCnt_int_int_indexby0_range0to1274502_groupby0_id2 _$$_edgeCnt1, Edge_int_int_nest1_indexby0_range0to1274502_groupby0_id1 _$$_edge3, Rank$1_int_double_indexby0_range0to1274502_groupby0_id5 $$headTable, SRuntime _$runtime, int _$firstTableIdx) {
        $const8=_$$const8;
        $_rank$00 = _$$_rank$00;
    ...
    public String toString() {
        String str="Rank$1(n,$Builtin.sum(r)) :- Rank$0(s,r1),EdgeCnt(s,cnt),r=((0.9*r1)/cnt),Edge(s,n). epoch:"+$epochId;
        return str;
    }
