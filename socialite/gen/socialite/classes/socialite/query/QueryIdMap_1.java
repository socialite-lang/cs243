...
public final class QueryIdMap_1 extends VisitorImpl implements QueryRunnable {
...
;
    public  QueryIdMap_1(IdMap_int_String_indexby0_range0to1274502_indexby1_groupby0_id0 __idMap_, QueryVisitor _queryVisitor, TableSliceMap _sliceMap) {
        _idMap_=__idMap_;
    ...
    public void run() {
        _idMap_.iterate_by_0($const1, this);
        queryVisitor.finish();
    }
