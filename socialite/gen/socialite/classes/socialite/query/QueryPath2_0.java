...
/* 
    for query: ?-Path2(67123,dist,prev). 
*/
...
public final class QueryPath2_0 extends VisitorImpl implements QueryRunnable {
    ...
    private int prev;
;
    public  QueryPath2_0(Path2_int_int_int_indexby0_range0to1274502_groupby0_id3 __path2_, QueryVisitor _queryVisitor, TableSliceMap _sliceMap) {
        _path2_=__path2_;
    ...
    public void run() {
        _path2_.iterate_by_0($const1, this);
        queryVisitor.finish();
    }
